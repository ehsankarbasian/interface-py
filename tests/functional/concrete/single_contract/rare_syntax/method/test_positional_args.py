...
class MethodContractPositionalArgsTestCase(TestCase):
    ...
    def test_success_star_and_slash(self):
        ...
        class MyInterface:
            ...
            def foo(self, par_1, par_2, /, par_3, par_4, par_5, *, par_6, par_7):
                pass
    ...
    def test_error_star_not_mentioned(self):
        expected_message = "Signature mismatch for 'foo' in concrete 'MyConcrete': expected (self, par_1, *, par_2), got (self, par_1, par_2)."
    ...
    def test_error_star_wrong_position(self):
        expected_message = "Signature mismatch for 'foo' in concrete 'MyConcrete': expected (self, par_1, *, par_2, par_3), got (self, par_1, par_2, *, par3)."
        
        @interface
        class MyInterface:
            
            def foo(self, par_1, *, par_2, par_3):
                pass
    ...
    def test_error_slash_wrong_position(self):
        expected_message = "Signature mismatch for 'foo' in concrete 'MyConcrete': expected (self, par_1, /, par_2, par_3), got (self, par_1, par_2, /, par_3)."
    ...
    def test_error_slash_and_star_not_mentioned_slash(self):
        expected_message = "Signature mismatch for 'foo' in concrete 'MyConcrete': expected (self, par_1, par_2, /, par_3, par_4, par_5, *, par_6, par_7), got (self, par_1, par_2, par_3, par_4, par_5, *, par_6, par_7)."
